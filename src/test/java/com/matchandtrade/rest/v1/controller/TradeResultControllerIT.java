...
public class TradeResultControllerIT extends BaseControllerIT {
	...
	public void get_When_ResultsAreGeneratedInCsvFormat() throws Exception {
		TradeResultFactory tradeResultFactory = new TradeResultFactory()
			.make(authenticatedUser, userHelper, tradeHelper, tradeService, membershipHelper, articleHelper, offerHelper, mockMvc, "text/csv");
	...
	public void get_When_ResultsAreGeneratedInJsonFormat_Then_Suceeds() throws Exception {
		TradeResultFactory tradeResultFactory = new TradeResultFactory()
			.make(authenticatedUser, userHelper, tradeHelper, tradeService, membershipHelper, articleHelper, offerHelper, mockMvc, MediaType.APPLICATION_JSON.toString());
